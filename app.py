...
# Initialize Objects
llm_model = Clarifai(pat="df3c2ef28c83412d89d021f048652fe6", user_id='openai', app_id='chat-completion', model_id='GPT-4')

llm_chain = LLMChain(llm=llm_model, prompt=llm_prompt, verbose=True)

aai.settings.api_key = "ccacc5c4a89b41e3aeaa1129b7a3398d"
